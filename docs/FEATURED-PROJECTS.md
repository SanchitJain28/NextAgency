...
**Project Overview**
Industrial Supply Direct is a specialized B2B eCommerce platform built for the industrial manufacturing and equipment sector. The project focused on transforming a complex technical catalog into a streamlined, high-converting procurement experience tailored for engineers, facility managers, and B2B buyers.

**Key Features & Implementation**

- **B2B-Optimized Architecture:** Developed a clean, professional, and utility-driven UI designed for rapid navigation and trust-building, highlighting industry experience and massive inventory scale directly on the homepage.
