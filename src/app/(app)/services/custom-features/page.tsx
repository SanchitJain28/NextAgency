...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Custom Shopify Features Development | ScaleFront",
    description:
      "Add unique functionality to your Shopify store. Product configurators, calculators, quizzes, custom tools.",
  },
  alternates: {
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              "Build unique functionality that sets your store apart with custom features and tools",
            provider: {
              "@type": "Organization",
              name: "ScaleFront",
            },
        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="max-w-3xl">
            ...
            <p className="text-base text-muted-foreground mb-8">
              Shopify provides core e-commerce features, but your business might
              need something special—product configurators, custom calculators,
              interactive quizzes, or unique tools your competitors don't have.
              We build custom features that become your competitive advantage.
            </p>
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <Button size="lg" variant="outline" asChild>
                <Link href="/contact-us">View Feature Examples</Link>
              </Button>
            </div>

            <p className="text-sm text-muted-foreground mt-6">
              Trusted by brands that refuse to be limited by standard
              functionality
            </p>
          </div>
        </div>
            ...
            {[
              {
                ...
                description:
                  "Build-to-order functionality where customers customize products in real-time with pricing updates.",
                examples: [
                ...
                timeline: "8-14 weeks",
                example:
                  "Built a furniture configurator showing 3D preview with fabric/wood choices. Increased AOV 34% and reduced returns 28%.",
              },
              {
                icon: Sparkles,
                ...
                description:
                  "Help customers find products through interactive questions.",
                examples: [
                ...
                timeline: "6-10 weeks",
                example:
                  "Built a skincare quiz that reduced product returns 41% and increased conversion 23% by matching customers better.",
              },
              {
                icon: Calculator,
                ...
                description:
                  "Custom calculators that assist purchase decisions.",
                examples: [
                ...
                timeline: "4-8 weeks",
                example:
                  "Built an ROI calculator for B2B SaaS showing 5-year savings. Increased B2B conversion 67%.",
              },
              {
                icon: ShoppingBag,
                ...
                description:
                  "Custom subscription logic that Recharge/Bold can't handle.",
                examples: [
                ...
                timeline: "8-12 weeks",
                example:
                  "Built a coffee subscription with custom blending, delivery calendar control, and rollover credits.",
              },
              {
                icon: Calendar,
                ...
                description:
                  "Integrated booking systems for services or rentals.",
                examples: [
                ...
                timeline: "8-12 weeks",
                example:
                  "Built a jewelry appointment system integrating with store calendar and sending automated reminders.",
              },
              {
                icon: Gift,
                ...
                description:
                  "Beyond standard loyalty apps when you need unique rules.",
                examples: [
                ...
                timeline: "6-10 weeks",
                example:
                  "Built a tiered membership with exclusive product drops and early access increasing repeat purchase rate 48%.",
              },
              {
                icon: Users,
                title: "B2B Portals",
                ...
                description:
                  "Beyond Shopify Plus native B2B when you need more.",
                examples: [
                ...
                example:
                  "Built a B2B portal with custom pricing matrices for 150+ wholesale customers.",
              },
              {
                icon: Video,
                ...
                description:
                  "Let customers visualize products in their space or on themselves.",
                examples: [
                ...
                example:
                  "Built AR furniture placement tool reducing returns 31% and increasing conversion 19%.",
              },
            ].map((feature) => {
          ...
          <div className="grid md:grid-cols-4 gap-6">
            {[
              ...
              },
              {
                ...
                title: "Design",
                description:
                  "Design the feature architecture and user experience",
                tasks: [
                  "UI/UX design",
                  "User flow mapping",
            ...
            <div className="max-w-4xl">
              <div className="mb-8">
                ...
                <p className="text-muted-foreground">
                  A jewelry brand wanted customers to design custom rings with
                  real-time pricing and 3D preview.
                </p>
              </div>
              ...
              <div className="mb-8">
                ...
                <p className="text-muted-foreground mb-4">
                  Built a custom configurator with:
                </p>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  {[
                    ...
                    },
                    {
                      ...
                      value: "8.7%",
                      note: "(vs. 2.1% regular products)",
                    },
                    {
                      label: "Revenue from Configured Products",
                      value: "34%",
                      note: "",
                    },
                    {
                      label: "Returns Reduced",
                      value: "42%",
                      note: "(better expectations)",
                    },
                  ].map((result) => (
                    <div
                      key={result.label}
            ...
            {[
              {
                ...
                answer:
                  "If it's technically possible and makes business sense, yes. We'll advise on feasibility and alternatives during our discovery phase.",
              },
              {
                question: "How long do custom features take?",
                answer:
                  "Simple features: 4-8 weeks. Medium complexity: 8-12 weeks. Complex features: 12-18 weeks. Timeline depends on complexity and requirements.",
              },
              {
                question: "Will features slow down our site?",
                answer:
                  "Not if built correctly. We optimize for performance. Many features actually improve engagement time and conversions.",
              },
              {
                question: "Can features be updated later?",
                answer:
                  "Yes. We build with future modifications in mind. You own the code and can adjust as needed.",
              },
              {
                question: "Do you maintain features after launch?",
                answer:
                  "We include 30 days support. Extended maintenance available on retainer starting at $1,000/month.",
              },
              {
                question: "What if our idea is very unique?",
                answer:
                  "That's what we specialize in. We've built everything from custom configurators to AR experiences. Schedule a consultation to discuss your vision.",
              },
            ].map((faq) => (
        ...
        <div className="mx-auto max-w-4xl px-6 text-center space-y-6">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            ...
            <Button
              ...
              asChild
            >
              <Link href="/contact-us">View Portfolio</Link>
            </Button>
          </div>
        </div>
      </section>
