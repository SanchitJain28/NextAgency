...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Actionable Shopify store audits covering site speed, mobile UX, conversion friction, and technical SEO from certified Shopify engineering experts.",
    url: "https://www.scalefront.io/services/audit-consulting",
    siteName: "ScaleFront",
    type: "website",
  },
  twitter: {
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              "Professional Shopify store audits covering performance, UX, conversion, SEO, and technical aspects. Expert consulting services.",
            offers: {
              "@type": "Offer",
        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="max-w-3xl">
            ...
            <p className="text-lg md:text-xl text-muted-foreground mb-4">
              Identify what's holding your store back. Get a roadmap to improve
              performance, conversions, and revenue.
            </p>

            <p className="text-base text-muted-foreground mb-8">
              Your store might look fine, but underneath there could be
              performance issues, UX problems, SEO gaps, or conversion killers
              costing you revenue every day. We conduct comprehensive audits
              across 8 critical areas and provide a prioritized action plan.
            </p>
            ...
            <p className="text-sm text-muted-foreground">
              ✓ Trusted by D2C brands serious about improving their Shopify
              stores
            </p>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-card rounded-xl border border-border p-6">
              ...
              <div className="p-4 bg-gradient-to-br from-primary/10 to-primary/5 rounded-lg border border-primary/20">
                ...
                <p className="text-sm text-muted-foreground">
                  Fashion brand stuck at ₹45L/month for 8 months. Audit revealed
                  mobile page load of 9.2 seconds, hidden reviews, and 82%
                  checkout abandonment. After fixes: +49% revenue increase to
                  ₹67L/month.
                </p>
              </div>
            </div>
      ...
      <section className="py-20">
        <div className="mx-auto max-w-7xl px-6">
          ...
          <p className="text-lg text-muted-foreground mb-8 max-w-3xl">
            We audit every critical aspect of your Shopify store and provide
            ...
            {[
              {
                ...
                deliverable:
                  "Performance score with benchmarks, specific bottlenecks, app recommendations, image optimization opportunities, estimated conversion impact.",
                example:
                  "Homepage loads in 8.2 seconds on mobile. Top issues: Unoptimized hero image (3.2MB), 14 unused apps adding JavaScript, no lazy loading. Fixing would reduce load time to ~2.1 seconds, potentially increasing mobile conversion by 28%.",
              },
              {
                ...
                deliverable:
                  "Annotated screenshots highlighting issues, user flow diagrams showing friction points, mobile-specific recommendations, comparison to best-in-class examples.",
                example:
                  "Mobile product page requires 7 taps to see product details, size guide, and reviews. 43% of mobile users bounce at this stage. Recommend collapsible accordions to reduce interaction cost.",
              },
              {
                ...
                deliverable:
                  "Conversion funnel analysis, specific abandonment points, A/B test recommendations prioritized by impact, quick wins vs. major improvements, estimated revenue impact.",
                example:
                  "Checkout abandonment at 78% (industry avg: 69%). Main issues: Unexpected shipping costs at final step, no guest checkout, required account creation. Fixing could recover ₹12L annually based on current traffic.",
              },
              {
                ...
                deliverable:
                  "Technical SEO issues prioritized by severity, keyword opportunity analysis, content improvement recommendations, structured data implementation, SEO roadmap with traffic impact.",
                example:
                  "47 products missing meta descriptions. 23 products have duplicate content from manufacturer descriptions. Blog hasn't been updated in 8 months. Fixing meta descriptions and creating product-focused content could increase organic traffic by 40%+ over 6 months.",
              },
              {
                ...
                deliverable:
                  "Mobile experience score, device-specific testing results (iOS, Android), mobile conversion killers identified, mobile-first redesign recommendations.",
                example:
                  "Mobile navigation menu requires precise tapping. Buttons are 36px (minimum is 44px). Product images don't zoom properly. 62% of mobile traffic but only 38% of conversions. Mobile optimization could add ₹8L annual revenue.",
              },
              {
                ...
                deliverable:
                  "Technical debt assessment, code quality score, security vulnerabilities identified, accessibility compliance report, technical improvement roadmap.",
                example:
                  "Theme using deprecated Shopify APIs that will break in 6 months. 8 JavaScript errors on every page load. No accessibility considerations (violates WCAG 2.1). Recommend theme update before issues compound.",
              },
              {
                ...
                deliverable:
                  "App inventory with usage analysis, performance impact score per app, cost savings opportunities, better alternative recommendations, apps to remove immediately.",
                example:
                  "Paying ₹42,000/month for 18 apps. 6 apps haven't been used in 3+ months. 4 apps have overlapping functionality. 3 apps significantly slow page load. Removing/consolidating could save ₹24,000/month and improve load time by 2.1 seconds.",
              },
              {
                ...
                deliverable:
                  "Tracking accuracy assessment, missing events identified, GA4 configuration recommendations, custom reporting suggestions, data quality issues fixed.",
                example:
                  "GA4 not tracking 32% of transactions due to checkout redirect issues. No event tracking for add-to-cart or product views. Unable to analyze customer journey or optimize marketing spend. Fixing tracking would enable data-driven optimization.",
              },
            ].map((audit) => {
            ...
            <div className="space-y-6">
              <div className="bg-card rounded-xl border border-border p-6">
                ...
                <p className="text-sm text-muted-foreground mb-4">
                  Video conference walk-through where we:
                </p>
        ...
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            {[
              ...
              <div
                key={index}
                className={`bg-card rounded-xl border p-8 ${tier.popular ? "border-primary border-2 relative" : "border-border"}`}
              >
                {tier.popular && (
          ...
          <div className="bg-card rounded-xl border border-border p-8">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                ...
                <p className="text-sm text-muted-foreground mb-4">
                  Retainer-based consulting for continuous optimization
                </p>
                <p className="text-sm font-medium mb-4">
                  For stores serious about continuous improvement
                </p>
              </div>
              <div>
            ...
            {[
              {
                title: "Fashion Brand",
                situation:
                  "Revenue stuck at ₹45L/month for 8 months despite increasing traffic.",
                findings: [
            ...
            {[
              {
                ...
                answer:
                  "Quick Audit: 3-5 days. Standard: 7-10 days. Premium: 10-14 days. Timeline depends on store size and complexity.",
              },
              {
                question: "Do you need access to our store?",
                answer:
                  "Yes. We need admin access, Google Analytics access, and any relevant app logins. We sign NDAs and maintain strict confidentiality.",
              },
              {
                question: "Can you audit our store while it's live?",
                answer:
                  "Yes. Audits are non-invasive. We analyze your store without making any changes.",
              },
              {
                question: "Do you provide implementation services?",
                answer:
                  "Yes. We can implement all audit recommendations or just the ones you choose. Implementation is separate from audit pricing.",
              },
              {
                question: "How do you prioritize recommendations?",
                answer:
                  "We prioritize based on: (1) potential revenue impact, (2) implementation complexity, (3) time to implement, (4) your specific goals.",
              },
              {
                question: "What if you don't find any issues?",
                answer:
                  "Rare, but possible for very well-optimized stores. We'd tell you honestly and refund a portion of the fee. Has never happened in 100+ audits.",
              },
            ].map((faq, index) => (
              <div
                key={index}
      ...
      <section className="py-20 bg-primary text-primary-foreground">
        <div className="mx-auto max-w-4xl px-6 text-center space-y-6">
          ...
          <p className="text-lg opacity-90">
            Get a comprehensive audit and discover opportunities for growth.
            Let's identify what's holding your store back and create a roadmap
            to improvement.
          </p>
          ...
          <p className="text-sm opacity-75">
            No obligation. No pressure. We'll discuss your store, challenges,
            and how an audit can help.
          </p>
        </div>
      </section>
    </div>
