  ...
  return (
    <div className={`${font_className}`}>
      <div className="min-h-screen bg-black text-white">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                ...
                <motion.div
                  ...
                  transition={{ delay: index * 0.1 }}
                  viewport={{ once: true }}
                  className="bg-white/5 p-8 rounded-xl hover:bg-white/10 transition border border-white/10 group"
                >
        ...
        <section
          id="how-it-works"
          className="py-20 bg-white/5 border-y border-white/10 px-4 sm:px-6 lg:px-8"
        >
          <div className="max-w-7xl mx-auto">
            <motion.div
              initial={{ opacity: 0, y: 20 }}
        ...
        <section className="py-20 bg-white/5 border-y border-white/10 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <motion.div
                initial={{ opacity: 0, x: -20 }}
              ...
              >
                <div className="bg-white/5 rounded-2xl shadow-2xl p-8 border border-white/10">
                  <div className="h-96 bg-gradient-to-br from-gray-900 to-black rounded-lg flex items-center justify-center border border-white/10">
                    <span className="text-gray-500">
                      Image: Customization Dashboard
                    </span>
                  </div>
                </div>
              </motion.div>
