...
export const metadata: Metadata = {
  title: "Earn - Free Shopify Store Auditor & Analysis Tool",
  description:
    "Get a comprehensive free audit of your Shopify store in 60 seconds. Analyze SEO, performance, accessibility, security, and sales optimization. 100+ checks to increase your conversion rate by up to 40%. No credit card required.",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "Analyze your Shopify store across 100+ factors in 60 seconds. Get actionable insights to increase conversion rates and sales.",
  ...
  twitter: {
    ...
    title: "Free Shopify Store Auditor - Earn by ScaleFront",
    description:
      "Get instant insights into your Shopify store's performance, SEO, and sales optimization. 100+ checks in 60 seconds.",
