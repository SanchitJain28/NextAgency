...
const PROJECTS: ProjectItem[] = [
  ...
  },
  {
    id: "maison-luxe",
    title: "Maison Luxe",
    tagline: "Scandinavian Luxury Home Decor & Editorial Theme",
    category: "Storefront",
    vertical: "Luxury Home Decor & Scandinavian Furniture",
    description:
      "An editorial eCommerce storefront designed for high-end interior decor. Built on Shopify Dawn with custom typography hierarchies, immersive lookbook routing, and native 'Shop the Look' multi-product hot-spot cards.",
    highlights: [
      "Editorial Brand Identity & Asymmetrical Storytelling",
      "Interactive 'Shop the Look' Room Collections",
      "Zero Third-Party Layout Shift",
    ],
    tags: ["Luxury Decor", "Editorial UI", "Shop the Look", "Dawn Customization"],
